    ...
    public static Direction[][] getDirectionArr() {
        ...
        Direction[] KolthoffToWilliamson = {
                ...
                new Direction("take elevator down to level B",
                        ...
                        R.drawable.kw7,
                        R.drawable.k3),
                new Direction("exit elevator, turn left and walk towards the doors at the end of the corridor. Continue through doors and enter Walter Library",
                        R.drawable.doubledoor,
                        R.drawable.kw8,
                        R.drawable.k3),
                new Direction("at end of corridor, turn left then immediately the first right",
                        ...
                        R.drawable.kw9,
                        R.drawable.k4),
                new Direction("walk to the end of hallway (80m), turn right, and then left following hallway",
                        R.drawable.ahead,
                        R.drawable.kw10,
                        R.drawable.k4),
                ...
                new Direction("Enter door labeled Northrop Garage and head up the stairs",
                        ...
                        R.drawable.kw13,
                        R.drawable.k5),
                new Direction("At the top of the stairs, open second door and enter Northrop Garage",
                        R.drawable.door,
                        R.drawable.kw14,
                        R.drawable.k5),
                new Direction("Walk across garage (200m) towards Morrill Hall",
                        ...
                        R.drawable.kw15,
                        R.drawable.k6),
                new Direction("Turn left and walk another 100m straight (down parking garage slope)",
                        R.drawable.left,
                        R.drawable.kw16,
                        R.drawable.k7),
                new Direction("Enter door towards Williamson Hall and follow tunnel path",
                        ...
                        R.drawable.kw17,
                        R.drawable.k7),
                new Direction("At the end of the tunnel, turn left, following signs to Williamson Hall",
                        R.drawable.left,
                        R.drawable.kw18,
                        R.drawable.k7),
